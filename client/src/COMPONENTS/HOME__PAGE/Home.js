...
function Home() {
  ...
  return (
    <>
      ...
      >
        <a href="https://api.whatsapp.com/send?phone=6264803084">
          <img
      ...
      <div style={{ position: "relative", overflowX: "hidden" }}>
        ...
        <div className="poster-container">
          ...
          <Row className="poster-body">
            <Col sm={6} className="poster-img">
              <img
                src={posters.poster[count - 1].imageUrl}
                data-Aos="zoom-in"
                alt="poster"
              />
            </Col>
            <Col sm={6} className="poster-smallPara">
              <p data-Aos="fade-left">{posters.poster[count - 1].smallPara}</p>
              <Link to="/poster">
                <h4 data-Aos="fade-up">See More</h4>
              </Link>
            </Col>
          </Row>
        </div>
        ...
        <div
          style={{
            backgroundImage: "linear-gradient(rgba(6, 175, 241, 0.795), white)",
          }}
        >
          <Social_media />
          <Aashraya_stats />
